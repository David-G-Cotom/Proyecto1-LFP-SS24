 ...
 * @author Carlos Cotom
 */
public class DocumentoReporteOptimizacion {
    
    private ArrayList<Token> tokensOptimizados = new ArrayList<>();
    ...
    private String obtenerCabeceraHTML() {
        return """
                <html>                   
                <head>
                      <title>Reporte de Tokens Optimizados</title>
                </head>
                <style>
                     table, th, td {
    ...
    private String generarContenido(String data) {
        data += """
                ...
                """;
        for (Token tokenAnalizado : tokensOptimizados) {
    ...
    private void generarReporte(String contenido) {
        String nombreBase = "reporteOptimizacion";
